...
var createMedicine, updateMedicine, deleteMedicine, getSellerMedicines, getSellerOrderItems, updateMainOrderStatus, updateOrderItemStatus, SellerService;
var init_seller_service = __esm({
  "src/modules/seller/seller.service.ts"() {
    "use strict";
    init_prisma();
    createMedicine = async (sellerId, data) => {
      if (!data.categoryId) {
    ...
    updateMedicine = async (medicineId, sellerId, data) => {
      return prisma.medicine.updateMany({
        where: { id: medicineId, sellerId },
        data
      });
    };
    deleteMedicine = async (medicineId, sellerId) => {
      return prisma.medicine.deleteMany({
        where: { id: medicineId, sellerId }
      });
    };
    getSellerMedicines = async (sellerId) => {
      return prisma.medicine.findMany({
        where: { sellerId },
        include: { category: true, reviews: true }
      });
    };
    getSellerOrderItems = async (sellerId) => {
    ...
    updateMainOrderStatus = async (orderId) => {
    ...
    updateOrderItemStatus = async (itemId, sellerId, status) => {
...
var addMedicine, updateMedicine2, deleteMedicine2, getMedicines, getOrders, updateOrderStatus, SellerController;
...
var createCategory, getAllCategories, getAllUsers, updateUserStatus, updateMedicineAvailability, approveMedicine, getAllOrders, getAllMedicines, AdminService;
var init_admin_service = __esm({
  "src/modules/admin/admin.service.ts"() {
    ...
    updateMedicineAvailability = async (medicineId, status) => {
      return prisma.medicine.update({
        where: { id: medicineId },
        data: { isActive: status === "AVAILABLE" }
      });
    };
    approveMedicine = async (medicineId, adminId) => {
      return prisma.medicine.update({
        where: { id: medicineId },
        data: {
          isApproved: true,
...
var addCategory, getCategories, getUsers, updateUserStatus2, updateMedicineAvailability2, getAllOrders2, getAllMedicines2, approveMedicine2, AdminController;
var init_admin_controller = __esm({
  "src/modules/admin/admin.controller.ts"() {
    ...
    updateMedicineAvailability2 = async (req, res) => {
      try {
        const { status } = req.body;
    ...
    getAllMedicines2 = async (_req, res) => {
      try {
    ...
    approveMedicine2 = async (req, res) => {
      try {
...
var getMedicines2, getMedicineById, getCategories2, PublicService;
var init_public_service = __esm({
  "src/modules/public/public.service.ts"() {
    "use strict";
    init_prisma();
    getMedicines2 = async (filters) => {
      const where = {
        isActive: true,
        isApproved: true
      };
...
var getMedicines3, getMedicineById2, getCategories3, PublicController;
var init_public_controller = __esm({
  "src/modules/public/public.controller.ts"() {
    "use strict";
    init_public_service();
    getMedicines3 = async (req, res) => {
      try {
...
var router3, PublicRouter;
var init_public_routes = __esm({
  "src/modules/public/public.routes.ts"() {
    "use strict";
...
var getCart, addToCart, updateCartItem, removeCartItem, placeOrder, getOrders2, getOrderById, addReview, updateProfile, getProfile, CustomerController;
